...
print("tools_visualizacion imported")
import random
...
import sys
print("sys imported")
from auxiliar import Avion, calcular_dist_entre_aviones, reubicar, franjas_y_vel_maxima, guardar_run_json
